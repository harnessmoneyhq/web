...
const content = readFileSync("../data/eval-content.json", "utf-8");

const asset = {
  title: "Synthetic LLM Eval — Multi-Category Benchmark Suite",
  category: "evaluation",
  price: "0.1",
  description:
    "50 synthetic LLM evaluation cases across 5 categories (factuality, instruction following, reasoning, safety, tool use) with scoring rubric, difficulty tiers, and pass/fail grading by synthetic judge.",
  content,
  model: "gpt-5.5",
};

async function main() {
  console.log("Publishing eval dataset...");
