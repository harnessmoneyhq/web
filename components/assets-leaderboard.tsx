...
import { AssetCategory } from "@/lib/assets-data";
...
export function AssetsLeaderboard() {
  ...
  const { assets, loading, error, retry } = useAssets();
  ...
  }, [assets, search, selectedCategory, activeTab, sortField, sortDirection]);
      ...
      {error ? (
        <div className="flex flex-col items-center justify-center py-20 gap-4">
          ...
          <button
            type="button"
            onClick={retry}
            className="px-4 py-2 rounded bg-neutral-900 border border-neutral-800 text-neutral-300 hover:text-white hover:border-neutral-700 font-mono text-sm cursor-pointer transition-colors"
          >
            Retry
          </button>
        </div>
        ...
        <div className="space-y-6">
          {/* Skeleton Search Bar */}
          <div className="h-11 w-full bg-neutral-800 animate-pulse rounded" />

          {/* Skeleton Filter Pills */}
          <div>
            <div className="h-3 w-16 bg-neutral-800 animate-pulse rounded mb-2" />
            <div className="flex items-center gap-2">
              {Array.from({ length: 7 }).map((_, i) => (
                <div key={i} className="h-8 rounded-full bg-neutral-800 animate-pulse" style={{ width: `${60 + (i % 3) * 20}px` }} />
              ))}
            </div>
          </div>
          ...
          <div>
            <div className="h-3 w-14 bg-neutral-800 animate-pulse rounded mb-2" />
            <div className="flex gap-6 border-b border-neutral-900 pb-2">
              {Array.from({ length: 6 }).map((_, i) => (
                <div key={i} className="h-4 rounded bg-neutral-800 animate-pulse" style={{ width: `${50 + (i % 3) * 20}px` }} />
              ))}
            </div>
          </div>
          ...
          <Table>
            <TableHeader className="border-b border-neutral-800/80">
              <TableRow className="border-b border-neutral-800/80 hover:bg-transparent">
                <TableHead className="w-12 px-3 py-3"><div className="h-3 w-4 bg-neutral-800 animate-pulse rounded" /></TableHead>
                <TableHead className="px-3 py-3"><div className="h-3 w-12 bg-neutral-800 animate-pulse rounded" /></TableHead>
                <TableHead className="px-3 py-3 hidden lg:table-cell"><div className="h-3 w-12 bg-neutral-800 animate-pulse rounded" /></TableHead>
                <TableHead className="px-3 py-3 hidden lg:table-cell"><div className="h-3 w-10 bg-neutral-800 animate-pulse rounded ml-auto" /></TableHead>
                <TableHead className="px-3 py-3 hidden lg:table-cell"><div className="h-3 w-20 bg-neutral-800 animate-pulse rounded ml-auto" /></TableHead>
                <TableHead className="px-3 py-3"><div className="h-3 w-16 bg-neutral-800 animate-pulse rounded ml-auto" /></TableHead>
              </TableRow>
            </TableHeader>
            <TableBody className="divide-y divide-neutral-900">
              {Array.from({ length: 10 }).map((_, i) => (
                <TableRow key={i} className="border-b border-neutral-900 hover:bg-transparent">
                  <TableCell className="px-3 py-3"><div className="h-4 w-5 bg-neutral-800 animate-pulse rounded" /></TableCell>
                  <TableCell className="px-3 py-3">
                    <div className="space-y-1.5">
                      <div className="h-4 bg-neutral-800 animate-pulse rounded" style={{ width: `${100 + (i % 4) * 30}px` }} />
                      <div className="h-3 w-16 bg-neutral-800 animate-pulse rounded" />
                    </div>
                  </TableCell>
                  <TableCell className="px-3 py-3 hidden lg:table-cell"><div className="h-5 w-20 bg-neutral-800 animate-pulse rounded" /></TableCell>
                  <TableCell className="px-3 py-3 hidden lg:table-cell"><div className="h-4 w-14 bg-neutral-800 animate-pulse rounded ml-auto" /></TableCell>
                  <TableCell className="px-3 py-3 hidden lg:table-cell"><div className="h-6 w-24 bg-neutral-800 animate-pulse rounded ml-auto" /></TableCell>
                  <TableCell className="px-3 py-3"><div className="h-4 w-12 bg-neutral-800 animate-pulse rounded ml-auto" /></TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
